...
clf=OneVsRestClassifier(BaggingClassifier(base_estimator=base_model,n_estimators=500,random_state=1))
...
fpr["macro"] = all_fpr
tpr["macro"] = mean_tpr
plt.title("Roc Curve for Bagged Decision Tree Classifier")
